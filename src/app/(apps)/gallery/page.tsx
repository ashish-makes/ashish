...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: "Gallery | Ashish",
        description: "A visual archive of captures and moments, exploring photography and the art of seeing.",
        url: "https://ashish.cv/gallery",
    },
    alternates: {
        canonical: "/gallery",
    },
...
export default async function GalleryPage() {
    ...
    const gallerySchema = {
        ...
        "@type": "ImageGallery",
        "name": "Ashish's Gallery",
        "description": metadata.description,
        "url": "https://ashish.cv/gallery",
        "image": images.slice(0, 20).map(img => img.url),
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Gallery", "item": "https://ashish.cv/gallery" }
        ]
    };
